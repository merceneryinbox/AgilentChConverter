...
public class AgilentChFileParserNIO_2 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////
        Files.readAllBytes(Paths.get(args.length != 2 ? defaultOutputFile : args[0]));
        //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(fileOut, true)) {
            ...
            while (randomFileLengthCount < 12181) {
                ...
                Files.write(getOutPath(args),
                            (charset.encode(CharBuffer.wrap(headerCharArray)).array()),
                            StandardOpenOption.WRITE);
                Files.write(getOutPath(args),
                            (charset.encode(CharBuffer.wrap(commonCharArray)).array()),
