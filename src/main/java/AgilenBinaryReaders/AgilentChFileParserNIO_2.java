...
public class AgilentChFileParserNIO_2 {
    ...
    public static void main(String[] args) throws Exception {
        AgilentChFileChooser application = new AgilentChFileChooser();
        ...
        try {
            ...
            while (inputFileByteReadPointOffset < fullInputFileArrayLength) {
                ...
                short
                        intensityCurrentStepIncreaseValue =
                ...
                resultStringAppender.append(
                        totalTimeValueInCurrentStep + "," + totalIntensityValueInCurrentStep + "\n");
            ...
            Files.write(getOutPath(args),
                        (charset.encode(CharBuffer.wrap(resultStringAppender.toString().toCharArray())).array()),
                        StandardOpenOption.CREATE);
        } catch (FileNotFoundException fnf) {
            System.err.println("Input file " + defaultChFilePath +
                               "seem to be in some another place or it's have been opened in time of access." +
